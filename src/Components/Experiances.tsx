...
const Experiences = () => {
  return (
    <div className="bg-[#22252c] py-[5rem]">
      <h1 className="edu font-bold text-5xl text-center mt-[4rem] mb-[6rem]">EXPERIENCES </h1>
        ...
        <Timeline position="left" sx={{}}>
          ...
          <TimelineItem position="right" sx={{}}>
            <TimelineOppositeContent>
              <h1 className="text-[#14e8c8] font-bold text-3xl">FRONT-END DEVELOPER</h1>
          ...
          <TimelineItem position="right" sx={{}}>
            ...
            <TimelineContent>
              <h1 className="text-[#14e8c8] font-bold text-3xl">WORDPRESS DESIGNER/ BLOGGER</h1>
              <h3 className="text-white">HEADLINE NEWS, LAGOS, NIGERIA | 2021 - 2023</h3>
            </TimelineContent>
          </TimelineItem>
          <TimelineItem position="right" sx={{}}>
            <TimelineOppositeContent>
              <h1 className="text-[#14e8c8] font-bold text-3xl">YOUTUBE CONTENT CREATOR</h1>
          ...
          <TimelineItem position="right" sx={{}}>
            <TimelineOppositeContent>
              <Typography color={"white"}>
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsum a eos fuga, officiis
                minima ipsam animi? Temporibus rerum delectus est.
              </Typography>
            </TimelineOppositeContent>
            <TimelineSeparator>
              <div className="w-[2rem] h-[2rem] rounded-full border-2 border-[#14e8c8] grid place-content-center">
              ...
              <TimelineConnector sx={{ height: "10rem", width: ".3rem", background: "#14e8c8" }} />
            </TimelineSeparator>
            <TimelineContent>
              <h1 className="text-[#14e8c8] font-bold text-3xl">
                MATHEMATICS/ CHEMISTRY INSTRUCTOR
              </h1>
              <h3 className="text-white">NATIONAL YOUTH SERVICE CORP | 2020 - Present</h3>
            </TimelineContent>
          </TimelineItem>
          <TimelineItem sx={{}}>
            <TimelineSeparator>
